from worktop.ai_workspace.app.ai_workspace.application.prompts.prompt_builder_service import StructuredPrompt
...
class PromptRenderer:
    ...
    def _render_user_prompt(self, prompt: StructuredPrompt) -> str:
        ...
        if prompt.repository_memory:
            sections.append(f"## Repository instructions and learned context\n{prompt.repository_memory}")
