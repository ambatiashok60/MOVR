...
from worktop.ai_workspace.app.ai_workspace.domain.agent_turn import AgentTurn
from worktop.ai_workspace.app.ai_workspace.application.agent.patch_validation_service import PatchValidationResult
