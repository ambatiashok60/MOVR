...
BANNER = "=" * 60
_LOG_LEVEL_ENV = "API_AGENT_LOG_LEVEL"
...
def configure_logging(level: int | None = None) -> None:
    ...
    Idempotent: modules call get_logger() at import time in any order. When
    the worktop platform's custom logger is installed it owns the handlers;
    this only guarantees a consistent fallback format outside the platform.
    """
    global _configured
    if level is None:
