...
class DefaultLLMClientAdapter:
    ...
    def complete(self, prompt: str) -> str:
        logger.debug("LLM completion started")
        ...
        logger.debug("LLM completion finished (%s chars)", len(text))
        return text
    ...
    def complete_structured(
        ...
        logger.debug(
            "Structured completion started (model schema: %s)", response_model.__name__
        )
        ...
        try:
            ...
            try:
                ...
                logger.error(
                    "Structured response for %s failed even after repair: %s",
                    response_model.__name__,
                    exc,
                )
                logger.exception(
